    ...
    public class DefaultInlineConstraintResolver : IInlineConstraintResolver
    {
        ...
        public virtual IRouteConstraint ResolveConstraint([NotNull] string inlineConstraint)
        {
            ...
            if (!typeof(IRouteConstraint).GetTypeInfo().IsAssignableFrom(constraintType.GetTypeInfo()))
            {
                ...
                //ErrorResources.DefaultInlineConstraintResolver_TypeNotConstraint, constraintType.Name, constraintKey);
            }
        ...
        private static object CreateConstraint(Type constraintType, string argumentString)
        {
            ...
            else
            {
                ...
                {
                    //throw Error.InvalidOperation(ErrorResources.DefaultInlineConstraintResolver_CouldNotFindCtor, constraintTypeInfo.Name, argumentString.Length);
                    throw new InvalidOperationException();
                }
                ...
                {
                    //throw Error.InvalidOperation(ErrorResources.DefaultInlineConstraintResolver_AmbiguousCtors, constraintTypeInfo.Name, argumentString.Length);
                    throw new InvalidOperationException();
                }
            }
